(function ($) {
    ...
    if (eduactTiltElm.length) {
        eduactTiltElm.each(function () {
            ...
            let eduactTilt = self.tilt("object" === typeof options ? options : JSON.parse(options));
        });
    }
    ...
    if ($(".counter-one__list").length) {
        ...
        let yearsCondition = undefined == $(".counter-one__list").data("enable-years") ? false : $(".counter-one__list").data("enable-years");
        let daysCondition = undefined == $(".counter-one__list").data("enable-days") ? true : $(".counter-one__list").data("enable-days");
        ...
        $(".counter-one__list").countdown({
            ...
            render: function (date) {
                this.el.innerHTML =
                    ...
                    (true == daysCondition ? "<li> <span class='days'> " + (true == leadingZeros ? this.leadingZeros(date.days) : date.days) + " <i> Days </i> </span> </li>" : " ") +
                    "<li> <span class='hours'>" +
